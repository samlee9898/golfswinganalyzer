...
## Swing Analyzer is live at [theswinganalyzer.com](https://theswinganalyzer.com)
![Swing Analyzer homepage](/screenshot.png)

## Features

- Create an account and sign in
- Upload golf swing videos
- View swing analyses generated by AI (Gemini)
